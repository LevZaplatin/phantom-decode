...
# Version:     1.0.1
#
# Info:         Phantom - технический и программный комплекс по перехвату телефонных разговоров на мини-АТС ipLDK-300 Office.
#                         Перехваченные звонки записываются в директорию D:\Phantom Records\ с расширением "nwu",
#                         запись разговора ведется "наживую", т.е. от начала и до конца разговора в nwu-файлы производится запись.
#                         По окончанию разговора в директорию D:\notifications\ добавляется мета-файл с расширением "ntf".
#                         Имена "ntf" и "nwu"-файлов одинаковые, 16-ое представление внутерннего ID записи.
#               MDISConverter - служба, позволяющая произвести конвертацию аудиозаписи в mp3-формат
#                               ожидает появление мета-файла в директории D:\notifications\, после чего производится 
#                               поиск "nwu"-файла
# Scheme:       
# Structure:    NTF - мета-файл, содержит только текстовую информацию о звонка:
#               ---------------------------------------------------------------------------------------------------------------
